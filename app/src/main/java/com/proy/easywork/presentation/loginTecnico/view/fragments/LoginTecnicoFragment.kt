...
class LoginTecnicoFragment : Fragment(){
...
//        }
    ...
    private fun setUpEvents() {
        binding.btnTelefono.setOnClickListener {
            Navigation.findNavController(it).navigate(R.id.action_loginTecnicoFragment_to_loginCodePhoneAuthTecnicoFragment)
        }

        binding.btnLogIn.setOnClickListener {
            Navigation.findNavController(it).navigate(R.id.action_loginTecnicoFragment_to_logInEmailPasswordTecnicoFragment)
        }
                ...
                override fun onSuccess(result: LoginResult) {
                    result?.let{
                        ...
                        if(actualLocation!=null){
                            actualLocation?.let {
                                viewModel.loginFacebookTecnico(RQAuthenticationFacebook(accessToken!!.token, it.latitude, it.longitude))
                            }
                        }else{
                            viewModel.loginFacebookTecnico(RQAuthenticationFacebook(accessToken!!.token,0.0,0.0))
                        }
        ...
        binding.btnGoogle.setOnClickListener {
            startActivityForResult(mGoogleSignInClient.signInIntent, LoginTecnicoFragment.RC_SIGN_IN)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == LoginTecnicoFragment.RC_SIGN_IN) {
    ...
    private fun handleSignInResult(completedTask: Task<GoogleSignInAccount>) {
        try {
            ...
            if(actualLocation!=null){
                actualLocation?.let {
                    viewModel.loginGoogleTecnico(RQAuthenticationGoogle(idToken,it.latitude,it.latitude))
                }
            }else{
                viewModel.loginGoogleTecnico(RQAuthenticationGoogle(idToken,0.0,0.0))
            }
