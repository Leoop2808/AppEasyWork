...
import com.proy.easywork.databinding.FragmentLogInEmailPasswordTecnicoBinding
...
class LogInEmailPasswordTecnicoFragment : Fragment(){
    private val sp: MDefaultSharedPref = MDataInjection.instance.providePreferences() as MDefaultSharedPref
    private lateinit var binding: FragmentLogInEmailPasswordTecnicoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLogInEmailPasswordTecnicoBinding.inflate(inflater, container, false)
        return binding.root
    }
