...
class PasswordRecoveryEmailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnRegistrate.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_passwordRecoveryEmailFragment_to_loginCodePhoneFragment)
        }

        binding.btnEnviar.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_passwordRecoveryEmailFragment_to_passwordRecoveryFragment)
        }
    }
}